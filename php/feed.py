...
# ---- gmail send email ----------
def send_email(emailConfig, petName, cupDuration, trigger):
...
def feed():
	...
	if emailNotifications == True:
		send_email(emailConfig, petName, cupDuration, trigger)
