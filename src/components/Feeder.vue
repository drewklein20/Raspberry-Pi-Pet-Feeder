...
<div>
    ...
    >
      ...
      <div class="main-content">
        ...
        <home v-if="selectedDrawerItem == 'Home'" :currentWeight="weightInGrams" :currentPercentage="weightPercentage" :settings="settings" @clickedDrawer="clickedDrawer"/>
...
export default {
  ...
  methods: {
    ...
    fetchData() {
      ...
      apiUrl =
        process.env.VUE_APP_BACKEND_URL + "?action=feeder_settings&id=1" 
      this.axios.get(apiUrl, {}).then((response) => {
